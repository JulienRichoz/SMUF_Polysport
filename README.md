...
1. **⚙️ Générateur de tournoi (Python)** : [SMUF_Polysport_Scheduler](https://github.com/JulienRichoz/SMUF_Polysport_Scheduler)
...
3. **📱 UI & Web App (App Script)** : [SMUF_Polysport_appScript](https://github.com/JulienRichoz/SMUF_Polysport_appScript)
