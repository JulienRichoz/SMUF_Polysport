...
> **Note importante** : La base du planning (les horaires et les rencontres) est générée en amont par cet outil : [SMUF Polysport Scheduler](https://github.com/JulienRichoz/SMUF_Polysport/tree/main/scheduler).
